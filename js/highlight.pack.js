...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
relevance:0,end:";",contains:[e.UNDERSCORE_TITLE_MODE]},l,c]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(e){return a("(?=",e,")")}
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
begin:/\\./}]}]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",i={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},s={className:"string",
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},t.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
end:/$/}]})})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
},contains:[c]}]}}})());hljs.registerLanguage("java",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){
return"("+n.map((n=>e(n))).join("|")+")"}return e=>{
...
contains:p}}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
